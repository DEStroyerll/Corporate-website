    ...
    <div id="content-home" class="content group">
        <div class="hentry group">
            <div class="section portfolio">
                ...
                <h3 class="title">{{trans('my_translations.latest_projects')}}</h3>

                <!--Здесь мы отображаем главный контент портфолио-->
                @foreach($portfolios as $key=>$item)
                    @if($key==0)
                        <div class="hentry work group portfolio-sticky portfolio-full-description">
                            <div class="work-thumbnail">
                                <a class="thumb"><img src="{{asset(env('THEME'))}}/images/projects/{{$item->img->max}}" alt="" title="" /></a>
                    ...
                    @if($key==1)
                        ...
                        @endif
                        <!--Секция в которой мы работаем с мини-изображениями-->
                            <div class="related_project {{($key==4) ? 'related_project_last' : ''}}">
                                <div class="overlay_a related_img">
                                    <div class="overlay_wrapper">
                                        <img src="{{asset(env('THEME'))}}/images/projects/{{$item->img->mini}}" alt="" title="" />
                                        <div class="overlay">
