<!--Макет пользовательской части сайта-->
<!DOCTYPE html>
...
<head>
    ...
    <!-- For first- and second-generation iPad: -->
    <link rel="apple-touch-icon-precomposed" sizes="72x72" href="{{asset('pink')}}" />
    ...
    <link rel="stylesheet" id="buttons" href="{{asset(env('THEME'))}}/css/buttons.cs" type="text/css" media="all" />
...
<div class="bg-shadow">
    ...
    <div id="wrapper" class="group">
        ...
        <div id="header" class="group">
            ...
            <div class="group inner">
                ...
                <div id="logo" class="group">
                    <a href="{{url('/')}}" title="Pink Rio"><img src="{{asset(env('THEME'))}}/images/logo.png" title="Pink Rio" alt="" /></a>
                </div>
                <!-- END LOGO -->
        ...
        <!--Проверка отображения записи в разделе Portfolio-->
